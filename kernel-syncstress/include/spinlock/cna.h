...
int cna_spin_is_locked(struct orig_qspinlock *lock)
{
	/*
 ...
 */
static __always_inline
void cna_spin_lock(struct orig_qspinlock *lock)
{
	u32 val;
...
static __always_inline
void cna_spin_unlock(struct orig_qspinlock *lock)
{
	/*
 ...
 */
static __always_inline
int cna_spin_trylock(struct orig_qspinlock *lock)
{
